...
description: Use proactively whenever the user deploys, configures, or troubleshoots applications on Vercel. Do not wait to be asked; delegate Vercel deployment work to this agent automatically. Covers edge functions, middleware, deployment strategies, performance optimization, and platform configuration.
tools:
- read
- edit
- execute
