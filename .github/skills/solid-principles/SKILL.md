...
description: ALWAYS load this skill whenever ANY code is being written, modified, reviewed, debugged, or discussed — regardless of language, framework, or task type. This is a universal skill that applies to every single coding activity without exception. Do not wait to be asked; apply automatically on every code-related interaction. Enforces SOLID principles, TDD, clean code practices, and professional software design to produce senior-engineer quality software.
---
